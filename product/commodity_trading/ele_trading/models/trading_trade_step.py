...
class TradingTradeStep(models.Model):
    ...
    workflow.step.mixin's shape works for a real vertical -- nothing in
    ...
    trading_trade.py's `ele_status`, already covers what Trading needs). See
    ...
    ele_blocked_by_step_ids = fields.Many2many(
        'trading.trade.step',
